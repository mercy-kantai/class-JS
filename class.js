...
const car = new Car("Maserati","XFAT",2020,"The car is available for rent")
...
const rentalCar = new Rental("Maserati","XFAT",2020,"The car is available for rent","Rental Households",20,30)
